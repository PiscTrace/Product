...
| 问题                        | 解答                                                                 |
|-----------------------------|----------------------------------------------------------------------|
| 在哪下载YOLO 模型？         | <a href="https://docs.ultralytics.com">YOLO</a> 获得官方发布预训练模型，<a href="https://huggingface.co">Huggingface</a> 搜索获得分享模型。         |
| 如何导入 YOLO 模型？        | 将 `.pt` 格式的 YOLO 模型放入目录： `解压地址/Support Files/data/model`   |
| 为什么没有 MiDaS 选项？     | - MiDaS 使用 **GitHub 在线资源与配置**<br>- 请确保网络可访问 GitHub<br>- **首次加载时间较长**，包括模型加载与配置 |
